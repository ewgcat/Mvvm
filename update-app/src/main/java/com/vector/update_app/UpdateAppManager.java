...
//                || !mTargetPath.startsWith(preSuffix)
    ...
    public void checkNewApp(final UpdateCallback callback) {
        ...
        Log.d("YYT","mUpdateUrl:"+mUpdateUrl);
        //网络请求
        if (isPost) {
            mHttpManager.asyncPost(mUpdateUrl, json, new HttpManager.Callback() {
                @Override
                public void onResponse(String result) {
                    Log.d("YYT","result:"+result);
                    callback.onAfter();
                    if (result != null) {
    ...
    public static class Builder {
        ...
        public Builder setJsonParams(String json) {
            this.json = json;
            return this;
        }
