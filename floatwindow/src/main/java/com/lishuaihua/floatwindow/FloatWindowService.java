...
public class FloatWindowService extends Service {
    ...
    private FloatPermissionDeleteViewFloatWindow mFloatPermissionDetectView;
    private FullScreenTouchAbleFloatWindowFloatWindow mFullScreenTouchAbleFloatWindow;
    private FullScreenTouchDisableFloatWindowFloatWindow mFullScreenTouchDisableFloatWindow;
    private NotFullScreenTouchDisableFloatWindowFloatWindow mNotFullScreenTouchDisableFloatWindow;
    private InputWindow mInputWindow;
    private AnimRevealFloatViewFloatWindow animRevealFloatView;
    ...
    private void showAnimWindow() {
        ...
        animRevealFloatView = new AnimRevealFloatViewFloatWindow(FloatWindowService.this);
    ...
    private synchronized void showFloatPermissionWindow() {
        ...
        mFloatPermissionDetectView = new FloatPermissionDeleteViewFloatWindow(getApplicationContext());
    ...
    private void showFullTouchWindow() {
        ...
        mFullScreenTouchAbleFloatWindow = new FullScreenTouchAbleFloatWindowFloatWindow(getApplicationContext());
    ...
    private void showFullTouchDisableWindow() {
        ...
        mFullScreenTouchDisableFloatWindow = new FullScreenTouchDisableFloatWindowFloatWindow(getApplicationContext());
    ...
    private void showNotFullTouchDisableWindow() {
        ...
        mNotFullScreenTouchDisableFloatWindow = new NotFullScreenTouchDisableFloatWindowFloatWindow(getApplicationContext());
    ...
    private void addForegroundNotification() {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(getApplicationContext(), NOTIFICATION_CHANNEL_ID)
                .setSmallIcon(com.lishuaihua.baselib.R.mipmap.ic_default_logo)
                .setLargeIcon(((BitmapDrawable) getResources().getDrawable(com.lishuaihua.baselib.R.mipmap.ic_default_logo)).getBitmap())
