...
public final class JackPermissions {
     ...
     */
    public static JackPermissions with(FragmentActivity activity) {
        return new JackPermissions(activity);
    }

    public static JackPermissions with(Context context) {
        return with(PermissionUtils.getFragmentActivity(context));
    }

    public static JackPermissions with(Fragment fragment) {
     ...
     * 私有化构造函数
     */
    private JackPermissions(FragmentActivity activity) {
        mActivity = activity;
    }
     ...
     * 设置权限组
     */
    public JackPermissions permission(String... permissions) {
     ...
     * 设置权限组
     */
    public JackPermissions permission(List<String> permissions) {
        if (mPermissions == null) {
    ...
    public void request(OnPermission callback) {
        ...
        if (JackPermissions.isGrantedPermission(mActivity, mPermissions)) {
    ...
    public static void startApplicationDetails(Context context) {
        ...
        Intent intent = PermissionSetting.getApplicationDetailsIntent(context);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.startActivity(intent);
    }

    public static void startApplicationDetails(Activity activity) {
        activity.startActivityForResult(PermissionSetting.getApplicationDetailsIntent(activity), REQUEST_CODE);
    }
    ...
    public static void startApplicationDetails(Fragment fragment) {
        ...
        fragment.startActivityForResult(PermissionSetting.getApplicationDetailsIntent(activity), REQUEST_CODE);
    }
    ...
    public static void startPermissionActivity(Context context, List<String> permissions) {
        ...
        Intent intent = PermissionSetting.getSmartPermissionIntent(context, permissions);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.startActivity(intent);
    }
    ...
    public static void startPermissionActivity(Activity activity, List<String> permissions) {
        activity.startActivityForResult(PermissionSetting.getSmartPermissionIntent(activity, permissions), REQUEST_CODE);
    }
    ...
    public static void startPermissionActivity(Fragment fragment, List<String> permissions) {
        ...
        fragment.startActivityForResult(PermissionSetting.getSmartPermissionIntent(activity, permissions), REQUEST_CODE);
    }
}